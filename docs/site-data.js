window.DOTFILES_DOCS_DATA = {
  ...
  "aliases": [
    ...
    {
      "name": "aiup",
      "command": "brew upgrade browseros claude-code@latest claude-devtools codex ollama omlx llmfit; mise upgrade gemini npm:@mariozechner/pi-coding-agent pipx:mini-swe-agent; pi update",
  ...
  "git": [
    ...
    },
    {
      ...
      "summary": "Find commits by author",
      "kind": "git alias",
      "source": "git/.gitconfig"
    },
    {
    ...
    },
    {
      ...
      "summary": "Show commits incoming from a branch's upstream (default: current branch). `git incoming` -> current branch vs its upstream; `git incoming main` -> main vs origin/main",
      "kind": "git alias",
      "source": "git/.gitconfig"
    },
    {
  ...
  "tasks": [
    ...
    },
    {
      ...
      "run": [
        "shfmt -d bootstrap.sh k9s/install.sh macos/.macos theme/install.sh glow/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
      ...
      "run": [
        "shfmt -w bootstrap.sh k9s/install.sh macos/.macos theme/install.sh glow/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
