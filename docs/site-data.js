window.DOTFILES_DOCS_DATA = {
  "git_revision": "aaa57b9f7a39c63057bc265ea2c6fc66ad3199fa",
  "source_hash": "3ee378c7b3f3",
  "stats": {
    "aliases": 69,
    "functions": 42,
    "git": 53,
  ...
  "functions": [
    {
      "name": "benchall",
      "summary": "Run a bounded benchmark across network, disk, RAM, CPU, GPU, and thermals, then print a Markdown report (also saved under ~/.cache/benchall) that is easy to hand to an agent for analysis.",
      "usage": "benchall [--no-net]",
    ...
    {
      "name": "omux",
      "summary": "macOS-only Omen tmux sessions. This deliberately stays out of system/ so it is never sourced by the Bash-based Omarchy bootstrap.",
      "usage": "omux ls",
      "source": "zsh/aliases.zsh",
      "source_kind": "zsh function"
    },
    {
      "name": "pcap",
  ...
  "bootstrap_links": [
    ...
    },
    {
      ...
      "target_path": "~/.config/tmux/tmux.conf",
  ...
  "packages": {
    ...
    "casks": [
      ...
      "karabiner-elements\" # App-scoped keyboard shortcut remapping",
