window.DOTFILES_DOCS_DATA = {
  ...
  "tasks": [
    ...
    },
    {
      ...
      "run": [
        "shfmt -d bootstrap.sh macos/.macos theme/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
      ...
      "run": [
        "shfmt -w bootstrap.sh macos/.macos theme/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
      ...
      "run": [
        "shellcheck bootstrap.sh macos/.macos theme/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
