window.DOTFILES_DOCS_DATA = {
  "git_revision": "bad70816ffc94356030c6b16374d5d4d81adb889",
  "source_hash": "1402dbfd9683",
  "stats": {
    "aliases": 58,
    "functions": 33,
    "git": 55,
  ...
  "tasks": [
    ...
    },
    {
      ...
      "run": [
        "shfmt -d bootstrap.sh macos/.macos theme/install.sh glow/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
      ...
      "run": [
        "shfmt -w bootstrap.sh macos/.macos theme/install.sh glow/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
      ...
      "run": [
        "shellcheck bootstrap.sh macos/.macos theme/install.sh glow/install.sh pi/install.sh zsh/.zshrc zsh/*.zsh scripts/*.sh"
      ],
      "source": "mise.toml"
    },
    {
  ...
  "bootstrap_links": [
    ...
    {
      "source_path": "pi/models.json",
      "target_path": "~/.pi/agent/models.json",
      "source": "pi/install.sh"
    },
    {
      "source_path": "pi/settings.json",
      "target_path": "~/.pi/agent/settings.json",
      "source": "pi/install.sh"
    },
    {
