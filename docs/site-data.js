window.DOTFILES_DOCS_DATA = {
  "git_revision": "7ad18bb4d6b62c75d1ae3a1a147674d7f8b79a98",
  "source_hash": "0eb8bfa252ab",
  "stats": {
    "aliases": 62,
    "functions": 33,
    "git": 56,
  ...
  "git": [
    ...
    {
      "name": "fa",
      "command": "\"!f() { git log --pretty=format:'%C(yellow)%h  %Cblue%ad  %Creset%s%Cgreen  [%cn] %Cred%d' --decorate --date=short --author=$1; }; f\"",
